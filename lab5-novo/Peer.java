...
/* Modificado por: João Pedro Padoan
 *
 * DONE1: Implementar unbind
 * DONE2: Usuário escolhe o peer ao qual deseja se conectar
 * DONE3: Adicionar um novo peer na lista de peers
 * DONE4: Interface gráfica para exibir os peers ativos
 */
...
public class Peer implements IMensagem {
	...
	public void iniciar() {
		...
		try {
			...
			System.out.print("Escolha um Peer para conectar: ");
			...
			while (repetido && !cheio){
				...
				if(repetido==true){
					System.out.print(peer.getNome() + " ativo. Escolha outro: ");
					escolha = scan.nextInt();
					peer = listaPeers.get(escolha - 1);
					tentativas+=1;
				}
